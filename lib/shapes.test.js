...
describe("Shapes", () => {
  //tests the render function for the Circle subclass
  describe("Circle", () => {
  ...
  //tests the render function for the Triangle subclass
  describe("Triangle", () => {
  ...
  //tests the render function for the Square subclass
  describe("Square", () => {
  ...
  //tests the render function for the RoundedSquare subclass
  describe("RoundedSquare", () => {
    it("should render a rounded square SVG string with the shape color provided", () => {
      ...
      expect(roundedSquare.render()).toEqual(
        `<rect x="25" y="25" rx="10" ry="10" width="150" height="150" stroke="black" fill="${this.color}" stroke-width="5"/>`
      );
    });
  });
});
